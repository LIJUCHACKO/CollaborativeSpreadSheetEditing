...
export default function DataSheet() {
    ...
    const deleteRow = (rowLabel) => {
        if (isFilterActive) return;
        if (!isRowEmpty(rowLabel)) {
            if (!window.confirm(`Row ${rowLabel} contains data. All content will be permanently deleted. Continue?`)) return;
        }
        if (canEdit && ws.current && ws.current.readyState === WebSocket.OPEN) {
                                ...
                                <tr>
                                    <th
                                        ...
                                        onContextMenu={(e) => {
                                            ...
                                            setRowHeaderMenu({ visible: true, x: e.clientX, y: e.clientY, row: '__corner__' });
                                        }}
                                        title="Right-click for row/column insert options"
                                    >
                                    ...
                                    <tr key={rowLabel}>
                                        ...
                                        >
                                            <div className="flex items-center justify-end h-full px-1" style={{ position: 'relative' }}>
                                                ...
                                                <span style={{ color: cutRow === rowLabel ? '#6366f1' : undefined, fontWeight: cutRow === rowLabel ? 700 : undefined }}>
                                                    {rowLabel}
                                                </span>
                                                {cutRow === rowLabel && (
                                ...
                                {rowHeaderMenu.row === '__corner__' ? (
                                    <>
                                        ...
                                        <button
                                            ...
                                            onMouseEnter={(e) => e.currentTarget.style.background = '#f0f4ff'}
                                            onMouseLeave={(e) => e.currentTarget.style.background = '#fff'}
                                            onClick={() => { insertColumnLeftOfFirst(); setRowHeaderMenu({ visible: false, x: 0, y: 0, row: null }); }}
                                        >
                                            <Plus size={14} className="text-indigo-500" /> Insert first column
                                        </button>
                                        <button
                                            className="d-flex align-items-center gap-2 w-100 text-start px-3 py-2 border-0 bg-white"
                                            style={{ cursor: 'pointer' }}
                                            ...
                                            onMouseEnter={(e) => e.currentTarget.style.background = '#f0f4ff'}
                                            onMouseLeave={(e) => e.currentTarget.style.background = '#fff'}
                                            onClick={() => { insertRowAboveFirst(); setRowHeaderMenu({ visible: false, x: 0, y: 0, row: null }); }}
                                        >
                                            <Plus size={14} className="text-indigo-500" /> Insert first row
                                        </button>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        >
                                            <Trash2 size={14} className="text-red-500" /> Delete row
                                        </button>
                                        {cutRow == null && (
                                            <button
                                                className="d-flex align-items-center gap-2 w-100 text-start px-3 py-2 border-0 bg-white"
                                            ...
                                            >
                                                <Scissors size={14} className="text-orange-500" /> Cut row
                                            </button>
                                        )}
